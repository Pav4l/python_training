...
class TestAddContact(unittest.TestCase):
    ...
    def test_add_contact(self):
        ...
        self.create_contact(wd, firtsname="Ivan", lastname="Ivanov", company="test1", address="test2", mobile="+799999999999", middlename="123456",
    ...
    def test_add_empty_contact(self):
        ...
        self.login(wd, username="admin", password="secret")
        self.open_and_new_contact_page(wd)
        self.create_contact(wd, firtsname="", lastname="", company="", address="", mobile="", middlename="",
                            nickname="", title="", home="",
    ...
    def create_contact(self, wd, firstname, lastname, company, address, mobile, middlename, nickname, title, home, work,
                       fax, email, email2, email3, homepage, bmonth, byear, bday, aday, amonth, new_group, ayear,
