...
class TestAddContact(unittest.TestCase):
    ...
    def test_add_contact(self):
        ...
        self.create_contact(wd, Contact(firstname="Ivan", lastname="Ivanov", company="test1", address="test2", mobile="+799999999999", middlename="123456",
    ...
    def test_add_empty_contact(self):
        ...
        self.login(wd, username="admin", password="secret")
        self.open_and_new_contact_page(wd)
        self.create_contact(wd, Contact(firstname="", lastname="", company="", address="", mobile="", middlename="",
                            nickname="", title="", home="",
