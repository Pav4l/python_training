...
def test_add_contact(app):
    ...
    app.open_and_new_contact_page()
    app.create_contact(Contact(firstname="Ivan", lastname="Ivanov", company="test1", address="test2", mobile="+799999999999", middlename="123456",
...
def test_add_empty_contact(app):
    ...
    app.login(username="admin", password="secret")
    app.open_and_new_contact_page()
    app.create_contact(Contact(firstname="", lastname="", company="", address="", mobile="", middlename="",
            nickname="", title="", home="",
